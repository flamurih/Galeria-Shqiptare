		...
		<!-- Header -->
			...
			<!-- Menu -->
						<nav id="menu" class="col-md-10 col-sm-10">
							<ul class="hidden-xs">
							<li><a href="index-1.html">Ballina</a>
							</li>
								<li> <a href="#">Galeria</a>
								</li>
								<li> <a class="menu-active" href="about.html">Foto e vitit</a></li>
								<li><a href="kontakti.html">Na Kontaktoni</a></li> 
							</ul>
			...
			<!-- Row -->
				<div class="row">
					<div class="col-md6 col-sm-6 col-xs-12">
						<img src="assets/images/viti.jpg" alt="Image description"  />
					</div>
					<div class="col-md6 col-sm-6 col-xs-12">
						<h3>Butrint, Albania</h3>
						<h4>Bukurite perrallore te Shqiperise jane te panumerta , me ndihmen e votave tuaja ne perfundim fotoja e vitit eshte perzgjedhur me me se shumti vota eshte ajo ne Butrint te Shqiperise . <a href="assets/images/viti.jpg">Kliko ketu per ta shikuar foton.</a>
						</4>
					</div>
